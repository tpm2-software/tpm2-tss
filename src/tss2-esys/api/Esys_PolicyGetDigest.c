...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyGetDi...
...
Esys_PolicyGetDigest(ESYS_CONTEXT  *esysContext,
    ...
    r = Esys_PolicyGetDigest_Async(esysContext, policySession, shandle1, shandle2, shandle3);
...
Esys_PolicyGetDigest_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_PolicyGetDigest_Prepare(esysContext->sys, (policySessionNode == NULL)
                                                               ? TPM2_RH_NULL
...
Esys_PolicyGetDigest_Finish(ESYS_CONTEXT *esysContext, TPM2B_DIGEST **policyDigest) {
    TSS2_RC r;
    LOG_TRACE("context=%p, policyDigest=%p", esysContext, policyDigest);
