...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_EC_Ephemeral
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_ECC_POINT, TPMI_ECC_CURVE, TPM2_R...
...
Esys_EC_Ephemeral(ESYS_CONTEXT     *esysContext,
    ...
    r = Esys_EC_Ephemeral_Async(esysContext, shandle1, shandle2, shandle3, curveID);
...
Esys_EC_Ephemeral_Async(ESYS_CONTEXT  *esysContext,
                        ...
                        TPMI_ECC_CURVE curveID) {
    TSS2_RC r;
    LOG_TRACE("context=%p, curveID=%04" PRIx16 "", esysContext, curveID);
...
Esys_EC_Ephemeral_Finish(ESYS_CONTEXT *esysContext, TPM2B_ECC_POINT **Q, UINT16 *counter) {
    TSS2_RC r;
    LOG_TRACE("context=%p, Q=%p, counter=%p", esysContext, Q, counter);
     ...
     */
    r = Tss2_Sys_EC_Ephemeral_Complete(esysContext->sys, (Q != NULL) ? *Q : NULL, counter);
