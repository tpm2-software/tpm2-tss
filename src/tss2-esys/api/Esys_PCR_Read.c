...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PCR_Read
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPML_PCR_SELECTION, TPML_DIGEST, TPM2_R...
...
Esys_PCR_Read(ESYS_CONTEXT             *esysContext,
    ...
    r = Esys_PCR_Read_Async(esysContext, shandle1, shandle2, shandle3, pcrSelectionIn);
     ...
     */
    do {
        r = Esys_PCR_Read_Finish(esysContext, pcrUpdateCounter, pcrSelectionOut, pcrValues);
...
Esys_PCR_Read_Async(ESYS_CONTEXT             *esysContext,
                    ...
                    const TPML_PCR_SELECTION *pcrSelectionIn) {
    TSS2_RC r;
    LOG_TRACE("context=%p, pcrSelectionIn=%p", esysContext, pcrSelectionIn);
...
Esys_PCR_Read_Finish(ESYS_CONTEXT        *esysContext,
    ...
    LOG_TRACE("context=%p, pcrUpdateCounter=%p, pcrSelectionOut=%p,"
              "pcrValues=%p",
              esysContext, pcrUpdateCounter, pcrSelectionOut, pcrValues);
