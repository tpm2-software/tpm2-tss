...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyPCR
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_DIGEST, TPML_PCR_SELECTION, TPM2_...
...
Esys_PolicyPCR(ESYS_CONTEXT             *esysContext,
    ...
    r = Esys_PolicyPCR_Async(esysContext, policySession, shandle1, shandle2, shandle3, pcrDigest,
                             pcrs);
