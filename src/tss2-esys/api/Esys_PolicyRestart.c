...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyRestart
...
Esys_PolicyRestart(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_PolicyRestart_Async(esysContext, sessionHandle, shandle1, shandle2, shandle3);
...
Esys_PolicyRestart_Async(ESYS_CONTEXT *esysContext,
                         ...
                         ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, sessionHandle=%" PRIx32 "", esysContext, sessionHandle);
    ...
    r = Tss2_Sys_PolicyRestart_Prepare(esysContext->sys, (sessionHandleNode == NULL)
                                                             ? TPM2_RH_NULL
