    ...
    TPML_AC_CAPABILITIES **capabilityData)
{
    ...
    r = Esys_AC_GetCapability_Async(esysContext, shandle1, shandle2, shandle3,
                                 ac, capability, count);
    ...
    UINT32 count)
{
    ...
    TSS2_RC r;
    LOG_TRACE("context=%p, ac=%"PRIx32 ", capability=%"PRIx32 ", "
            "count=%"PRIx32, esysContext, ac, capability, count);
    ...
    r = Tss2_Sys_AC_GetCapability_Prepare(
            esysContext->sys,
            ac,
            capability,
            count);
