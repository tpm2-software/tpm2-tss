...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyNvWri...
...
Esys_PolicyNvWritten(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_PolicyNvWritten_Async(esysContext, policySession, shandle1, shandle2, shandle3,
                                   writtenSet);
...
Esys_PolicyNvWritten_Async(ESYS_CONTEXT *esysContext,
                           ...
                           TPMI_YES_NO   writtenSet) {
    TSS2_RC r;
    LOG_TRACE("context=%p, policySession=%" PRIx32 ", writtenSet=%02" PRIx8 "", esysContext,
              policySession, writtenSet);
    ...
    r = Tss2_Sys_PolicyNvWritten_Prepare(
        esysContext->sys,
        (policySessionNode == NULL) ? TPM2_RH_NULL : policySessionNode->rsrc.handle, writtenSet);
