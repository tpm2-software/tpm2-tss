...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_NV_WriteLock
...
Esys_NV_WriteLock(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_NV_WriteLock_Async(esysContext, authHandle, nvIndex, shandle1, shandle2, shandle3);
...
Esys_NV_WriteLock_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_NV_WriteLock_Prepare(
