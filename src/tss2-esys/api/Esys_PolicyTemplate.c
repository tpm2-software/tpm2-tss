...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyTemplate
...
Esys_PolicyTemplate(ESYS_CONTEXT       *esysContext,
    ...
    r = Esys_PolicyTemplate_Async(esysContext, policySession, shandle1, shandle2, shandle3,
                                  templateHash);
...
Esys_PolicyTemplate_Async(ESYS_CONTEXT       *esysContext,
                          ...
                          const TPM2B_DIGEST *templateHash) {
    TSS2_RC r;
    LOG_TRACE("context=%p, policySession=%" PRIx32 ", templateHash=%p", esysContext, policySession,
              templateHash);
    ...
    r = Tss2_Sys_PolicyTemplate_Prepare(
        esysContext->sys,
        (policySessionNode == NULL) ? TPM2_RH_NULL : policySessionNode->rsrc.handle, templateHash);
