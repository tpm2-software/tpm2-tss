...
#include "tss2_tpm2_types.h" // for TPM2_RH_NULL, TPM2_RC_RETRY, TPM2_RC_TE...
...
Esys_NV_UndefineSpace(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_NV_UndefineSpace_Async(esysContext, authHandle, nvIndex, shandle1, shandle2, shandle3);
...
Esys_NV_UndefineSpace_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_NV_UndefineSpace_Prepare(
