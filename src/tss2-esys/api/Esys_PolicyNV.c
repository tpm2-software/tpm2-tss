...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyNV
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2_RH_NULL, TPM2B_OPERAND, TPM2_EO
...
Esys_PolicyNV(ESYS_CONTEXT        *esysContext,
    ...
    r = Esys_PolicyNV_Async(esysContext, authHandle, nvIndex, policySession, shandle1, shandle2,
                            shandle3, operandB, offset, operation);
...
Esys_PolicyNV_Async(ESYS_CONTEXT        *esysContext,
    ...
    LOG_TRACE("context=%p, authHandle=%" PRIx32 ", nvIndex=%" PRIx32 ","
              ...
              "operation=%04" PRIx16 "",
              esysContext, authHandle, nvIndex, policySession, operandB, offset, operation);
    ...
    r = Tss2_Sys_PolicyNV_Prepare(
        ...
        (policySessionNode == NULL) ? TPM2_RH_NULL : policySessionNode->rsrc.handle, operandB,
        offset, operation);
