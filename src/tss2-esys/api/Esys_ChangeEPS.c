...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_ChangeEPS
...
Esys_ChangeEPS(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_ChangeEPS_Async(esysContext, authHandle, shandle1, shandle2, shandle3);
