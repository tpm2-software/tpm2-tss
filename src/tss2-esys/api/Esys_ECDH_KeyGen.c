...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_ECDH_KeyGen
...
Esys_ECDH_KeyGen(ESYS_CONTEXT     *esysContext,
    ...
    r = Esys_ECDH_KeyGen_Async(esysContext, keyHandle, shandle1, shandle2, shandle3);
...
Esys_ECDH_KeyGen_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_ECDH_KeyGen_Prepare(
...
Esys_ECDH_KeyGen_Finish(ESYS_CONTEXT     *esysContext,
                        ...
                        TPM2B_ECC_POINT **pubPoint) {
    TSS2_RC r;
    LOG_TRACE("context=%p, zPoint=%p, pubPoint=%p", esysContext, zPoint, pubPoint);
     ...
     */
    r = Tss2_Sys_ECDH_KeyGen_Complete(esysContext->sys, (zPoint != NULL) ? *zPoint : NULL,
