...
Esys_SequenceComplete(ESYS_CONTEXT           *esysContext,
    ...
    r = Esys_SequenceComplete_Async(esysContext, sequenceHandle, shandle1, shandle2, shandle3,
                                    buffer, hierarchy);
...
Esys_SequenceComplete_Async(ESYS_CONTEXT           *esysContext,
    ...
    r = Tss2_Sys_SequenceComplete_Prepare(
        esysContext->sys,
...
Esys_SequenceComplete_Finish(ESYS_CONTEXT       *esysContext,
                             ...
                             TPMT_TK_HASHCHECK **validation) {
    TSS2_RC r;
    LOG_TRACE("context=%p, result=%p, validation=%p", esysContext, result, validation);
     ...
     */
    r = Tss2_Sys_SequenceComplete_Complete(esysContext->sys, (result != NULL) ? *result : NULL,
