...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyCpHash
...
Esys_PolicyCpHash(ESYS_CONTEXT       *esysContext,
    ...
    r = Esys_PolicyCpHash_Async(esysContext, policySession, shandle1, shandle2, shandle3, cpHashA);
...
Esys_PolicyCpHash_Async(ESYS_CONTEXT       *esysContext,
                        ...
                        const TPM2B_DIGEST *cpHashA) {
    TSS2_RC r;
    LOG_TRACE("context=%p, policySession=%" PRIx32 ", cpHashA=%p", esysContext, policySession,
              cpHashA);
    ...
    r = Tss2_Sys_PolicyCpHash_Prepare(
        esysContext->sys,
        (policySessionNode == NULL) ? TPM2_RH_NULL : policySessionNode->rsrc.handle, cpHashA);
