...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyCount...
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_OPERAND, TPM2_EO, TPM2_RC_RETRY
...
Esys_PolicyCounterTimer(ESYS_CONTEXT        *esysContext,
    ...
    r = Esys_PolicyCounterTimer_Async(esysContext, policySession, shandle1, shandle2, shandle3,
...
Esys_PolicyCounterTimer_Async(ESYS_CONTEXT        *esysContext,
    ...
    r = Tss2_Sys_PolicyCounterTimer_Prepare(
        esysContext->sys,
