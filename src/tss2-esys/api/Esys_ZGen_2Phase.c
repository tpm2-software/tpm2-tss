...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_ZGen_2Phase
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_ECC_POINT, TPMI_ECC_KEY_EXCHANGE
...
Esys_ZGen_2Phase(ESYS_CONTEXT          *esysContext,
    ...
    r = Esys_ZGen_2Phase_Async(esysContext, keyA, shandle1, shandle2, shandle3, inQsB, inQeB,
                               inScheme, counter);
...
Esys_ZGen_2Phase_Async(ESYS_CONTEXT          *esysContext,
    ...
    LOG_TRACE("context=%p, keyA=%" PRIx32 ", inQsB=%p,"
              ...
              esysContext, keyA, inQsB, inQeB, inScheme, counter);
    ...
    return_state_if_error(r, ESYS_STATE_INIT, "keyA unknown.");
    ...
    if (keyANode != NULL)
        iesys_compute_session_value(esysContext->session_tab[0], &keyANode->rsrc.name,
                                    &keyANode->auth);
    else
...
Esys_ZGen_2Phase_Finish(ESYS_CONTEXT     *esysContext,
                        ...
                        TPM2B_ECC_POINT **outZ2) {
    TSS2_RC r;
    LOG_TRACE("context=%p, outZ1=%p, outZ2=%p", esysContext, outZ1, outZ2);
     ...
     */
    r = Tss2_Sys_ZGen_2Phase_Complete(esysContext->sys, (outZ1 != NULL) ? *outZ1 : NULL,
