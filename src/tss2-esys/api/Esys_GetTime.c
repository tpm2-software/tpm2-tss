...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_GetTime
...
Esys_GetTime(ESYS_CONTEXT          *esysContext,
    ...
    r = Esys_GetTime_Async(esysContext, privacyAdminHandle, signHandle, shandle1, shandle2,
 ...
 */
TSS2_RC
Esys_GetTime_Finish(ESYS_CONTEXT    *esysContext,
                    TPM2B_ATTEST   **timeInfo,
                    TPMT_SIGNATURE **signature) {
    TSS2_RC r;
    LOG_TRACE("context=%p, timeInfo=%p, signature=%p", esysContext, timeInfo, signature);
     ...
     */
    r = Tss2_Sys_GetTime_Complete(esysContext->sys, (timeInfo != NULL) ? *timeInfo : NULL,
