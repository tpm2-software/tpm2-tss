...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_ECC_Parameters
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPMS_ALGORITHM_DETAIL_ECC, TPMI_ECC_CURVE
...
Esys_ECC_Parameters(ESYS_CONTEXT               *esysContext,
    ...
    r = Esys_ECC_Parameters_Async(esysContext, shandle1, shandle2, shandle3, curveID);
...
Esys_ECC_Parameters_Finish(ESYS_CONTEXT *esysContext, TPMS_ALGORITHM_DETAIL_ECC **parameters) {
    TSS2_RC r;
    LOG_TRACE("context=%p, parameters=%p", esysContext, parameters);
