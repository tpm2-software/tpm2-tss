...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_SetAlgorith...
...
Esys_SetAlgorithmSet(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_SetAlgorithmSet_Async(esysContext, authHandle, shandle1, shandle2, shandle3,
                                   algorithmSet);
...
Esys_SetAlgorithmSet_Async(ESYS_CONTEXT *esysContext,
                           ...
                           UINT32        algorithmSet) {
    TSS2_RC r;
    LOG_TRACE("context=%p, authHandle=%" PRIx32 ", algorithmSet=%" PRIx32 "", esysContext,
              authHandle, algorithmSet);
    ...
    r = Tss2_Sys_SetAlgorithmSet_Prepare(
