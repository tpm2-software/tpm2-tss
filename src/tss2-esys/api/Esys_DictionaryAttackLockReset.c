...
Esys_DictionaryAttackLockReset(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_DictionaryAttackLockReset_Async(esysContext, lockHandle, shandle1, shandle2, shandle3);
...
Esys_DictionaryAttackLockReset_Async(ESYS_CONTEXT *esysContext,
                                     ...
                                     ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, lockHandle=%" PRIx32 "", esysContext, lockHandle);
    ...
    r = Tss2_Sys_DictionaryAttackLockReset_Prepare(
