...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_NV_ReadLock
...
Esys_NV_ReadLock(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_NV_ReadLock_Async(esysContext, authHandle, nvIndex, shandle1, shandle2, shandle3);
...
Esys_NV_ReadLock_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_NV_ReadLock_Prepare(
