...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_Sign, Esys_...
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPMT_SIGNATURE, TPM2B_DIGEST, TPMT_SIG_...
...
Esys_Sign(ESYS_CONTEXT            *esysContext,
    ...
    r = Esys_Sign_Async(esysContext, keyHandle, shandle1, shandle2, shandle3, digest, inScheme,
                        validation);
...
Esys_Sign_Finish(ESYS_CONTEXT *esysContext, TPMT_SIGNATURE **signature) {
     ...
     */
    r = Tss2_Sys_Sign_Complete(esysContext->sys, (signature != NULL) ? *signature : NULL);
