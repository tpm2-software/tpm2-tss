...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PP_Commands
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPML_CC, TPM2_RC_RETRY, TPM2_RC_TESTING
...
Esys_PP_Commands(ESYS_CONTEXT  *esysContext,
    ...
    r = Esys_PP_Commands_Async(esysContext, auth, shandle1, shandle2, shandle3, setList, clearList);
