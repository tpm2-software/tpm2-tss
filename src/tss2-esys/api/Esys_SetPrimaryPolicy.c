...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_SetPrimaryP...
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_DIGEST, TPMI_ALG_HASH, TPM2_RC_RETRY
...
Esys_SetPrimaryPolicy(ESYS_CONTEXT       *esysContext,
    ...
    r = Esys_SetPrimaryPolicy_Async(esysContext, authHandle, shandle1, shandle2, shandle3,
                                    authPolicy, hashAlg);
...
Esys_SetPrimaryPolicy_Async(ESYS_CONTEXT       *esysContext,
    ...
    r = Tss2_Sys_SetPrimaryPolicy_Prepare(
