...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyAutho...
...
Esys_PolicyAuthorize(ESYS_CONTEXT           *esysContext,
    ...
    r = Esys_PolicyAuthorize_Async(esysContext, policySession, shandle1, shandle2, shandle3,
...
Esys_PolicyAuthorize_Async(ESYS_CONTEXT           *esysContext,
    ...
    LOG_TRACE("context=%p, policySession=%" PRIx32 ", approvedPolicy=%p,"
              ...
              esysContext, policySession, approvedPolicy, policyRef, keySign, checkTicket);
    ...
    r = Tss2_Sys_PolicyAuthorize_Prepare(
        esysContext->sys,
        (policySessionNode == NULL) ? TPM2_RH_NULL : policySessionNode->rsrc.handle, approvedPolicy,
