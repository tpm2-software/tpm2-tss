...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_SelfTest
...
Esys_SelfTest(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_SelfTest_Async(esysContext, shandle1, shandle2, shandle3, fullTest);
...
Esys_SelfTest_Async(ESYS_CONTEXT *esysContext,
                    ...
                    TPMI_YES_NO   fullTest) {
    TSS2_RC r;
    LOG_TRACE("context=%p, fullTest=%02" PRIx8 "", esysContext, fullTest);
