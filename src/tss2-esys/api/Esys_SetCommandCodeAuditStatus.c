...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_SetCommandC...
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPML_CC, TPMI_ALG_HASH, TPM2_RC_RETRY
...
Esys_SetCommandCodeAuditStatus(ESYS_CONTEXT  *esysContext,
    ...
    r = Esys_SetCommandCodeAuditStatus_Async(esysContext, auth, shandle1, shandle2, shandle3,
...
Esys_SetCommandCodeAuditStatus_Async(ESYS_CONTEXT  *esysContext,
    ...
    r = Tss2_Sys_SetCommandCodeAuditStatus_Prepare(
        esysContext->sys, (authNode == NULL) ? TPM2_RH_NULL : authNode->rsrc.handle, auditAlg,
        setList, clearList);
