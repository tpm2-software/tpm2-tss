...
#include "esys_types.h"      // for IESYS_RESOURCE, IESYS_RSRC_UNION
#include "tss2_common.h"     // for TSS2_RC, TSS2_RC_SUCCESS, TSS2_BASE_RC_...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_NV_ChangeAuth
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_AUTH, TPM2B_NV_PUBLIC, TPM2_RC_RETRY
...
static void
store_input_parameters(ESYS_CONTEXT *esysContext, ESYS_TR nvIndex, const TPM2B_AUTH *newAuth) {
...
Esys_NV_ChangeAuth(ESYS_CONTEXT     *esysContext,
    ...
    r = Esys_NV_ChangeAuth_Async(esysContext, nvIndex, shandle1, shandle2, shandle3, newAuth);
...
Esys_NV_ChangeAuth_Async(ESYS_CONTEXT     *esysContext,
                         ...
                         const TPM2B_AUTH *newAuth) {
    TSS2_RC r;
    LOG_TRACE("context=%p, nvIndex=%" PRIx32 ", newAuth=%p", esysContext, nvIndex, newAuth);
    ...
    r = Tss2_Sys_NV_ChangeAuth_Prepare(esysContext->sys, nvIndexNode->rsrc.handle, newAuth);
