...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_NV_GlobalWr...
...
Esys_NV_GlobalWriteLock(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_NV_GlobalWriteLock_Async(esysContext, authHandle, shandle1, shandle2, shandle3);
...
Esys_NV_GlobalWriteLock_Async(ESYS_CONTEXT *esysContext,
                              ...
                              ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, authHandle=%" PRIx32 "", esysContext, authHandle);
    ...
    r = Tss2_Sys_NV_GlobalWriteLock_Prepare(
