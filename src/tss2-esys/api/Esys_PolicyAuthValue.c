...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyAuthV...
...
Esys_PolicyAuthValue(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_PolicyAuthValue_Async(esysContext, policySession, shandle1, shandle2, shandle3);
...
Esys_PolicyAuthValue_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_PolicyAuthValue_Prepare(esysContext->sys, (policySessionNode == NULL)
                                                               ? TPM2_RH_NULL
