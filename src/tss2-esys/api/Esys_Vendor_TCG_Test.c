...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_Vendor_TCG_...
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPM2B_DATA, TPM2_RC_RETRY, TPM2_RC_TESTING
...
Esys_Vendor_TCG_Test(ESYS_CONTEXT     *esysContext,
    ...
    r = Esys_Vendor_TCG_Test_Async(esysContext, shandle1, shandle2, shandle3, inputData);
...
Esys_Vendor_TCG_Test_Async(ESYS_CONTEXT     *esysContext,
                           ...
                           const TPM2B_DATA *inputData) {
    TSS2_RC r;
    LOG_TRACE("context=%p, inputData=%p", esysContext, inputData);
...
Esys_Vendor_TCG_Test_Finish(ESYS_CONTEXT *esysContext, TPM2B_DATA **outputData) {
    TSS2_RC r;
    LOG_TRACE("context=%p, outputData=%p", esysContext, outputData);
