...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyTicket
...
Esys_PolicyTicket(ESYS_CONTEXT        *esysContext,
    ...
    r = Esys_PolicyTicket_Async(esysContext, policySession, shandle1, shandle2, shandle3, timeout,
...
Esys_PolicyTicket_Async(ESYS_CONTEXT        *esysContext,
    ...
    LOG_TRACE("context=%p, policySession=%" PRIx32 ", timeout=%p,"
              ...
              "ticket=%p",
              esysContext, policySession, timeout, cpHashA, policyRef, authName, ticket);
