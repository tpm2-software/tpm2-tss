...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_StirRandom
...
Esys_StirRandom(ESYS_CONTEXT               *esysContext,
    ...
    r = Esys_StirRandom_Async(esysContext, shandle1, shandle2, shandle3, inData);
...
Esys_StirRandom_Async(ESYS_CONTEXT               *esysContext,
                      ...
                      const TPM2B_SENSITIVE_DATA *inData) {
    TSS2_RC r;
    LOG_TRACE("context=%p, inData=%p", esysContext, inData);
