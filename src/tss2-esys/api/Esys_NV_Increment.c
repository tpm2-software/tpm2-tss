...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_NV_Increment
...
Esys_NV_Increment(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_NV_Increment_Async(esysContext, authHandle, nvIndex, shandle1, shandle2, shandle3);
...
Esys_NV_Increment_Async(ESYS_CONTEXT *esysContext,
                        ...
                        ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, authHandle=%" PRIx32 ", nvIndex=%" PRIx32 "", esysContext, authHandle,
              nvIndex);
    ...
    r = Tss2_Sys_NV_Increment_Prepare(
