...
#include "tss2_common.h"     // for TSS2_RC, UINT32, TSS2_RC_SUCCESS, TSS2_...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PCR_Allocate
#include "tss2_sys.h"        // for Tss2_Sys_ExecuteAsync, TSS2L_SYS_AUTH_C...
#include "tss2_tpm2_types.h" // for TPMI_YES_NO, TPML_PCR_SELECTION, TPM2_R...
...
Esys_PCR_Allocate(ESYS_CONTEXT             *esysContext,
    ...
    r = Esys_PCR_Allocate_Async(esysContext, authHandle, shandle1, shandle2, shandle3,
                                pcrAllocation);
     ...
     */
    do {
        r = Esys_PCR_Allocate_Finish(esysContext, allocationSuccess, maxPCR, sizeNeeded,
                                     sizeAvailable);
...
Esys_PCR_Allocate_Async(ESYS_CONTEXT             *esysContext,
                        ...
                        const TPML_PCR_SELECTION *pcrAllocation) {
    TSS2_RC r;
    LOG_TRACE("context=%p, authHandle=%" PRIx32 ", pcrAllocation=%p", esysContext, authHandle,
              pcrAllocation);
    ...
    r = Tss2_Sys_PCR_Allocate_Prepare(
...
Esys_PCR_Allocate_Finish(ESYS_CONTEXT *esysContext,
    ...
    LOG_TRACE("context=%p, allocationSuccess=%p, maxPCR=%p,"
              ...
              esysContext, allocationSuccess, maxPCR, sizeNeeded, sizeAvailable);
     ...
     */
    r = Tss2_Sys_PCR_Allocate_Complete(esysContext->sys, allocationSuccess, maxPCR, sizeNeeded,
                                       sizeAvailable);
