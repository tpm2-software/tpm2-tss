...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PolicyPhysi...
...
Esys_PolicyPhysicalPresence(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_PolicyPhysicalPresence_Async(esysContext, policySession, shandle1, shandle2, shandle3);
...
Esys_PolicyPhysicalPresence_Async(ESYS_CONTEXT *esysContext,
    ...
    r = Tss2_Sys_PolicyPhysicalPresence_Prepare(
        esysContext->sys,
