...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_ChangePPS
...
Esys_ChangePPS(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_ChangePPS_Async(esysContext, authHandle, shandle1, shandle2, shandle3);
