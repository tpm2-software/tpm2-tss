...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_PCR_Reset
...
Esys_PCR_Reset(ESYS_CONTEXT *esysContext,
    ...
    r = Esys_PCR_Reset_Async(esysContext, pcrHandle, shandle1, shandle2, shandle3);
...
Esys_PCR_Reset_Async(ESYS_CONTEXT *esysContext,
                     ...
                     ESYS_TR       shandle3) {
    TSS2_RC r;
    LOG_TRACE("context=%p, pcrHandle=%" PRIx32 "", esysContext, pcrHandle);
