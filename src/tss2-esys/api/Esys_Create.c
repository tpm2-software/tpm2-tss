...
#include "tss2_common.h"     // for TSS2_RC, TSS2_ESYS_RC_MEMORY, TSS2_RC_S...
#include "tss2_esys.h"       // for ESYS_CONTEXT, ESYS_TR, Esys_Create, Esy...
...
#include "util/log.h" // for return_state_if_error, SAFE_FREE, LOG_D...
...
Esys_Create(ESYS_CONTEXT                 *esysContext,
    ...
    r = Esys_Create_Async(esysContext, parentHandle, shandle1, shandle2, shandle3, inSensitive,
     ...
     */
    do {
        r = Esys_Create_Finish(esysContext, outPrivate, outPublic, creationData, creationHash,
                               creationTicket);
...
Esys_Create_Async(ESYS_CONTEXT                 *esysContext,
    ...
    LOG_TRACE("context=%p, parentHandle=%" PRIx32 ", inSensitive=%p,"
              ...
              esysContext, parentHandle, inSensitive, inPublic, outsideInfo, creationPCR);
...
Esys_Create_Finish(ESYS_CONTEXT         *esysContext,
    ...
    LOG_TRACE("context=%p, outPrivate=%p, outPublic=%p,"
              ...
              esysContext, outPrivate, outPublic, creationData, creationHash, creationTicket);
     ...
     */
    r = Tss2_Sys_Create_Complete(esysContext->sys, (outPrivate != NULL) ? *outPrivate : NULL,
