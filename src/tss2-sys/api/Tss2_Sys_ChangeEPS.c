...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CHANGEEPS_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CHANGEEPS_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CHANGEEPS)
