...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CERTIFY_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CERTIFY_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CERTIFY)
