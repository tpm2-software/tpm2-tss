...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_TESTPARMS_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_TESTPARMS_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_TESTPARMS)
