...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_UNDEFINESPACE_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_UNDEFINESPACE_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_UNDEFINESPACE)
