...
TSS2_RC
Tss2_Sys_SetPrimaryPolicy_Prepare(TSS2_SYS_CONTEXT      *sysContext,
...
TSS2_RC
Tss2_Sys_SetPrimaryPolicy_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_SetPrimaryPolicy(TSS2_SYS_CONTEXT             *sysContext,
                          TPMI_RH_HIERARCHY_AUTH        authHandle,
