...
TSS2_RC
Tss2_Sys_GetCommandAuditDigest_Prepare(TSS2_SYS_CONTEXT      *sysContext,
    ...
    rval = Tss2_MU_UINT32_Marshal(privacyHandle, ctx->cmdBuffer, ctx->maxCmdSize, &ctx->nextData);
    if (rval)
        return rval;
...
TSS2_RC
Tss2_Sys_GetCommandAuditDigest_Complete(TSS2_SYS_CONTEXT *sysContext,
...
TSS2_RC
Tss2_Sys_GetCommandAuditDigest(TSS2_SYS_CONTEXT             *sysContext,
                               TPMI_RH_ENDORSEMENT           privacyHandle,
                               TPMI_DH_OBJECT                signHandle,
    ...
    rval = Tss2_Sys_GetCommandAuditDigest_Prepare(sysContext, privacyHandle, signHandle,
    ...
    return Tss2_Sys_GetCommandAuditDigest_Complete(sysContext, auditInfo, signature);
}
