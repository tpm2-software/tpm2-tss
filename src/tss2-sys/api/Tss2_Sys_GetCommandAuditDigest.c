...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_GETCOMMANDAUDITDIGEST_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_GETCOMMANDAUDITDIGEST_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_GETCOMMANDAUDITDIGEST)
