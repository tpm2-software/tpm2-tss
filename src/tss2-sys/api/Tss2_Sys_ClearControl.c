...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CLEARCONTROL_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CLEARCONTROL_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_CLEARCONTROL)
