...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_ECDH_KEYGEN_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_ECDH_KEYGEN_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_ECDH_KEYGEN)
