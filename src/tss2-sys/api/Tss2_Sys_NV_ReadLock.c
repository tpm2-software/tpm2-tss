...
TSS2_RC
Tss2_Sys_NV_ReadLock_Prepare(TSS2_SYS_CONTEXT *sysContext,
...
TSS2_RC
Tss2_Sys_NV_ReadLock_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_NV_ReadLock(TSS2_SYS_CONTEXT             *sysContext,
                     TPMI_RH_NV_AUTH               authHandle,
                     TPMI_RH_NV_INDEX              nvIndex,
