...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PP_COMMANDS_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PP_COMMANDS_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PP_COMMANDS)
