...
TSS2_RC
Tss2_Sys_PP_Commands_Prepare(TSS2_SYS_CONTEXT *sysContext,
...
TSS2_RC
Tss2_Sys_PP_Commands_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_PP_Commands(TSS2_SYS_CONTEXT             *sysContext,
                     TPMI_RH_PLATFORM              auth,
