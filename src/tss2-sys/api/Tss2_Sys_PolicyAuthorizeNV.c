...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_POLICYAUTHORIZENV_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_POLICYAUTHORIZENV_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_POLICYAUTHORIZENV)
