...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_WRITELOCK_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_WRITELOCK_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_WRITELOCK)
