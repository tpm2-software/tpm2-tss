...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PCR_SETAUTHVALUE_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PCR_SETAUTHVALUE_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_PCR_SETAUTHVALUE)
