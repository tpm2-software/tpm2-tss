...
TSS2_RC
Tss2_Sys_ReadPublic_Prepare(TSS2_SYS_CONTEXT *sysContext, TPMI_DH_OBJECT objectHandle) {
...
TSS2_RC
Tss2_Sys_ReadPublic_Complete(TSS2_SYS_CONTEXT *sysContext,
    ...
    return Tss2_MU_TPM2B_NAME_Unmarshal(ctx->cmdBuffer, ctx->maxCmdSize, &ctx->nextData,
                                        qualifiedName);
}
