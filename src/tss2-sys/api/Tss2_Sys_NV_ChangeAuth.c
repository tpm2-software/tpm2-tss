...
TSS2_RC
Tss2_Sys_NV_ChangeAuth_Prepare(TSS2_SYS_CONTEXT *sysContext,
...
TSS2_RC
Tss2_Sys_NV_ChangeAuth_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_NV_ChangeAuth(TSS2_SYS_CONTEXT             *sysContext,
                       TPMI_RH_NV_INDEX              nvIndex,
