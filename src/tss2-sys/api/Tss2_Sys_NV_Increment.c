...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_INCREMENT_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_INCREMENT_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_NV_INCREMENT)
