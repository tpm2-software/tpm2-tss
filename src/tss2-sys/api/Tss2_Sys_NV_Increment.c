...
TSS2_RC
Tss2_Sys_NV_Increment_Prepare(TSS2_SYS_CONTEXT *sysContext,
...
TSS2_RC
Tss2_Sys_NV_Increment_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_NV_Increment(TSS2_SYS_CONTEXT             *sysContext,
                      TPMI_RH_NV_AUTH               authHandle,
                      TPMI_RH_NV_INDEX              nvIndex,
