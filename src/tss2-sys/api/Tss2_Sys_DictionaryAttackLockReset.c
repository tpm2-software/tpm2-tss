...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_DICTIONARYATTACKLOCKRESET_PREPARE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_DICTIONARYATTACKLOCKRESET_COMPLETE)
...
#if !defined(CONFIGURATOR) || defined(ENABLE_TSS2_SYS_DICTIONARYATTACKLOCKRESET)
