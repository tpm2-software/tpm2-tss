...
TSS2_RC
Tss2_Sys_PolicyDuplicationSelect_Prepare(TSS2_SYS_CONTEXT *sysContext,
    ...
    if (!newParentName) {
        ...
        rval = Tss2_MU_TPM2B_NAME_Marshal(newParentName, ctx->cmdBuffer, ctx->maxCmdSize,
                                          &ctx->nextData);
    }
...
TSS2_RC
Tss2_Sys_PolicyDuplicationSelect_Complete(TSS2_SYS_CONTEXT *sysContext) {
    TSS2_SYS_CONTEXT_BLOB *ctx = syscontext_cast(sysContext);
...
TSS2_RC
Tss2_Sys_PolicyDuplicationSelect(TSS2_SYS_CONTEXT             *sysContext,
                                 TPMI_SH_POLICY                policySession,
    ...
    rval = Tss2_Sys_PolicyDuplicationSelect_Prepare(sysContext, policySession, objectName,
