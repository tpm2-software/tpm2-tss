...
static TSS2_RC
tcti_yielder_transmit(TSS2_TCTI_CONTEXT *tctiContext, size_t size, const uint8_t *buffer) {
...
tcti_yielder_initialize(TSS2_TCTI_CONTEXT *tctiContext, size_t *contextSize) {
    TSS2_TCTI_CONTEXT_YIELDER *tcti_yielder = (TSS2_TCTI_CONTEXT_YIELDER *)tctiContext;
...
test_PolicyLocality(void **state) {
    ...
    r = Esys_PolicyLocality(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_AC_GetCapability(void **state) {
    ...
    TPMI_YES_NO           moreData;
    r = Esys_AC_GetCapability(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, ac, property,
