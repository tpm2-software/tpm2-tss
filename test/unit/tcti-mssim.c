...
conf_str_to_host_port_success_test(void **state) {
    ...
    mssim_conf_t mssim_conf = { .path = unusedpath };
...
conf_str_to_host_port_no_port_test(void **state) {
    ...
    char         unusedpath[] = NO_PATH_VALUE;
    mssim_conf_t mssim_conf = { .host = "foo", .port = NO_PORT_VALUE, .path = unusedpath };
...
conf_str_to_host_ipv6_port_no_port_test(void **state) {
    TSS2_RC      rc;
    char         conf[] = "host=::1";
    mssim_conf_t mssim_conf = { .port = NO_PORT_VALUE, .path = NO_PATH_VALUE };
...
conf_str_to_path_success_test(void **state) {
    ...
    mssim_conf_t mssim_conf = { .host = unusedhost };
...
main(int argc, char *argv[]) {
    const struct CMUnitTest tests[] = {
        ...
        cmocka_unit_test_setup_teardown(tcti_mssim_get_poll_handles_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_socket_receive_null_size_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_socket_receive_success_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_socket_receive_size_success_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_mssim_receive_eof_first_read_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_mssim_receive_eof_second_read_test, tcti_socket_setup,
                                        tcti_socket_teardown),
        cmocka_unit_test_setup_teardown(tcti_socket_transmit_success_test, tcti_socket_setup,
                                        tcti_socket_teardown),
#ifndef _WIN32
        cmocka_unit_test_setup_teardown(tcti_socket_receive_success_test, tcti_socket_setup_unix,
                                        tcti_socket_teardown),
#endif
    };
