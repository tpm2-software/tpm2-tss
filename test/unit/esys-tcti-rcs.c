...
#include <inttypes.h> // for uint8_t, PRIu32, uint32_t, int32_t
#include <stdlib.h>   // for NULL, exit, size_t, free, malloc
...
#include "tss2_common.h"          // for TSS2_RC, TSS2_TCTI_RC_NO_CONNECTION
#include "tss2_esys.h"            // for Esys_GetTcti, ESYS_TR_NONE, ESYS_C...
#include "tss2_tcti.h"            // for TSS2_TCTI_CONTEXT, TSS2_TCTI_CANCEL
#include "tss2_tpm2_types.h"      // for TPM2B_DIGEST, TPM2B_DATA, TPM2B_MA...
...
static TSS2_RC
tcti_tryagainerror_transmit(TSS2_TCTI_CONTEXT *tctiContext, size_t size, const uint8_t *buffer) {
    ...
    LOG_ERROR("Expected 2 receives before the next transmit, but %" PRIu32 "receives occurred.",
              tcti->count);
...
test_Shutdown(void **state) {
    ...
    r = Esys_Shutdown(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, shutdownType);
...
test_SelfTest(void **state) {
    ...
    r = Esys_SelfTest(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, 0);
    assert_int_equal(r, TSS2_TCTI_RC_NO_CONNECTION);
}
...
test_IncrementalSelfTest(void **state) {
    ...
    TPML_ALG  toTest = { 0 };
    TPML_ALG *toDoList = { 0 };
    r = Esys_IncrementalSelfTest(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &toTest,
                                 &toDoList);
...
test_GetTestResult(void **state) {
    ...
    TPM2_RC           testResult;
    r = Esys_GetTestResult(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &outData,
                           &testResult);
...
test_StartAuthSession(void **state) {
    ...
    r = Esys_StartAuthSession(esys_context, tpmKey_handle, bind_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                              ESYS_TR_NONE, &nonceCaller, sessionType, &symmetric, authHash,
...
test_PolicyRestart(void **state) {
    ...
    r = Esys_PolicyRestart(esys_context, DUMMY_TR_HANDLE_POLICY_SESSION, ESYS_TR_NONE, ESYS_TR_NONE,
                           ESYS_TR_NONE);
...
test_Create(void **state) {
    ...
    r = Esys_Create(esys_context, DUMMY_TR_HANDLE_KEY, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_Load(void **state) {
    ...
    r = Esys_Load(esys_context, DUMMY_TR_HANDLE_KEY, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                  &inPrivate, &inPublic, &objectHandle_handle);
...
test_LoadExternal(void **state) {
    ...
    r = Esys_LoadExternal(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, NULL, &inPublic,
                          ESYS_TR_RH_OWNER, &objectHandle_handle);
...
test_ReadPublic(void **state) {
    ...
    r = Esys_ReadPublic(esys_context, objectHandle_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_ActivateCredential(void **state) {
    ...
    r = Esys_ActivateCredential(esys_context, activateHandle_handle, keyHandle_handle,
                                ESYS_TR_PASSWORD, ESYS_TR_PASSWORD, ESYS_TR_NONE, &credentialBlob,
                                &secret, &certInfo);
...
test_MakeCredential(void **state) {
    ...
    r = Esys_MakeCredential(esys_context, handle_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_Unseal(void **state) {
    ...
    r = Esys_Unseal(esys_context, itemHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                    &outData);
...
test_ObjectChangeAuth(void **state) {
    ...
    TPM2B_PRIVATE *outPrivate;
    r = Esys_ObjectChangeAuth(esys_context, objectHandle_handle, parentHandle_handle,
                              ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE, &newAuth, &outPrivate);
...
test_Duplicate(void **state) {
    ...
    r = Esys_Duplicate(esys_context, objectHandle_handle, newParentHandle_handle, ESYS_TR_PASSWORD,
                       ESYS_TR_NONE, ESYS_TR_NONE, &encryptionKeyIn, &symmetricAlg,
...
test_Rewrap(void **state) {
    ...
    TPM2B_ENCRYPTED_SECRET *outSymSeed;
    r = Esys_Rewrap(esys_context, oldParent_handle, newParent_handle, ESYS_TR_PASSWORD,
                    ESYS_TR_NONE, ESYS_TR_NONE, &inDuplicate, &name, &inSymSeed, &outDuplicate,
                    &outSymSeed);
...
test_Import(void **state) {
    ...
    TPMT_SYM_DEF_OBJECT    symmetricAlg = DUMMY_SYMMETRIC;
    TPM2B_PRIVATE         *outPrivate;
    r = Esys_Import(esys_context, parentHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                    &encryptionKey, &objectPublic, &duplicate, &inSymSeed, &symmetricAlg,
                    &outPrivate);
...
test_RSA_Encrypt(void **state) {
    ...
    r = Esys_RSA_Encrypt(esys_context, keyHandle_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                         &message, &inScheme, &label, &outData);
...
test_RSA_Decrypt(void **state) {
    ...
    r = Esys_RSA_Decrypt(esys_context, keyHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                         ESYS_TR_NONE, &cipherText, &inScheme, &label, &message);
...
test_ECDH_KeyGen(void **state) {
    ...
    r = Esys_ECDH_KeyGen(esys_context, keyHandle_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                         &zPoint, &pubPoint);
...
test_ECDH_ZGen(void **state) {
    ...
    r = Esys_ECDH_ZGen(esys_context, keyHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                       &inPoint, &outPoint);
...
test_ZGen_2Phase(void **state) {
    ...
    r = Esys_ZGen_2Phase(esys_context, keyA_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_EncryptDecrypt(void **state) {
    ...
    r = Esys_EncryptDecrypt(esys_context, keyHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                            ESYS_TR_NONE, decrypt, mode, &ivIn, &inData, &outData, &ivOut);
...
test_EncryptDecrypt2(void **state) {
    ...
    r = Esys_EncryptDecrypt2(esys_context, keyHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                             ESYS_TR_NONE, &inData, decrypt, mode, &ivIn, &outData, &ivOut);
...
test_GetRandom(void **state) {
    ...
    r = Esys_GetRandom(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, bytesRequested,
                       &randomBytes);
...
test_SequenceComplete(void **state) {
    ...
    r = Esys_SequenceComplete(esys_context, sequenceHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                              ESYS_TR_NONE, &buffer, hierarchy, &result, &validation);
...
test_Certify(void **state) {
    ...
    r = Esys_Certify(esys_context, objectHandle_handle, signHandle_handle, ESYS_TR_PASSWORD,
                     ESYS_TR_PASSWORD, ESYS_TR_NONE, &qualifyingData, &inScheme, &certifyInfo,
                     &signature);
...
test_CertifyCreation(void **state) {
    ...
    TPM2B_ATTEST    *certifyInfo;
    TPMT_SIGNATURE  *signature;
    r = Esys_CertifyCreation(esys_context, signHandle_handle, objectHandle_handle, ESYS_TR_PASSWORD,
                             ESYS_TR_NONE, ESYS_TR_NONE, &qualifyingData, &creationHash, &inScheme,
...
test_Quote(void **state) {
    ...
    TPM2B_ATTEST      *quoted;
    TPMT_SIGNATURE    *signature;
    r = Esys_Quote(esys_context, signHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_GetSessionAuditDigest(void **state) {
    ...
    TPMT_SIGNATURE *signature;
    r = Esys_GetSessionAuditDigest(esys_context, privacyAdminHandle_handle, signHandle_handle,
                                   sessionHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_PASSWORD,
                                   ESYS_TR_NONE, &qualifyingData, &inScheme, &auditInfo,
                                   &signature);
...
test_GetCommandAuditDigest(void **state) {
    ...
    TPM2B_ATTEST   *auditInfo;
    TPMT_SIGNATURE *signature;
    r = Esys_GetCommandAuditDigest(esys_context, privacyHandle_handle, signHandle_handle,
...
test_GetTime(void **state) {
    ...
    TPMT_SIGNATURE *signature;
    r = Esys_GetTime(esys_context, privacyAdminHandle_handle, signHandle_handle, ESYS_TR_PASSWORD,
...
test_Commit(void **state) {
    ...
    TPM2B_ECC_POINT     *E;
    UINT16               counter;
    r = Esys_Commit(esys_context, signHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                    &P1, &s2, &y2, &K, &L, &E, &counter);
...
test_EC_Ephemeral(void **state) {
    ...
    TPM2B_ECC_POINT *Q;
    UINT16           counter;
    r = Esys_EC_Ephemeral(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, curveID, &Q,
                          &counter);
...
test_VerifySignature(void **state) {
    ...
    r = Esys_VerifySignature(esys_context, keyHandle_handle, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_Sign(void **state) {
    ...
    TPMT_SIGNATURE   *signature;
    r = Esys_Sign(esys_context, keyHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_SetCommandCodeAuditStatus(void **state) {
    ...
    r = Esys_SetCommandCodeAuditStatus(esys_context, auth_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                                       ESYS_TR_NONE, auditAlg, &setList, &clearList);
...
test_PCR_Allocate(void **state) {
    ...
    r = Esys_PCR_Allocate(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                          ESYS_TR_NONE, &pcrAllocation, &allocationSuccess, &maxPCR, &sizeNeeded,
                          &sizeAvailable);
...
test_PolicySigned(void **state) {
    ...
    r = Esys_PolicySigned(esys_context, authObject_handle, policySession_handle, ESYS_TR_NONE,
                          ESYS_TR_NONE, ESYS_TR_NONE, &nonceTPM, &cpHashA, &policyRef, expiration,
                          &auth, &timeout, &policyTicket);
...
test_PolicySecret(void **state) {
    ...
    TPM2B_TIMEOUT *timeout;
    TPMT_TK_AUTH  *policyTicket;
    r = Esys_PolicySecret(esys_context, authHandle_handle, policySession_handle, ESYS_TR_PASSWORD,
                          ESYS_TR_NONE, ESYS_TR_NONE, &nonceTPM, &cpHashA, &policyRef, expiration,
                          &timeout, &policyTicket);
...
test_PolicyTicket(void **state) {
    ...
    r = Esys_PolicyTicket(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                          ESYS_TR_NONE, &timeout, &cpHashA, &policyRef, &authName, &ticket);
...
test_PolicyOR(void **state) {
    ...
    r = Esys_PolicyOR(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                      &pHashList);
...
test_PolicyPCR(void **state) {
    ...
    r = Esys_PolicyPCR(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                       &pcrDigest, &pcrs);
...
test_PolicyLocality(void **state) {
    ...
    r = Esys_PolicyLocality(esys_context, policySession, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                            locality);
...
test_PolicyNV(void **state) {
    ...
    UINT16        offset = 0;
    TPM2_EO       operation = 0;
    r = Esys_PolicyNV(esys_context, authHandle_handle, nvIndex_handle, policySession_handle,
                      ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE, &operandB, offset, operation);
...
test_PolicyCounterTimer(void **state) {
    ...
    UINT16        offset = 0;
    TPM2_EO       operation = 0;
    r = Esys_PolicyCounterTimer(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_PolicyCommandCode(void **state) {
    ...
    r = Esys_PolicyCommandCode(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                               ESYS_TR_NONE, code);
...
test_PolicyPhysicalPresence(void **state) {
    ...
    ESYS_TR policySession_handle = DUMMY_TR_HANDLE_POLICY_SESSION;
    r = Esys_PolicyPhysicalPresence(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                                    ESYS_TR_NONE);
...
test_PolicyCpHash(void **state) {
    ...
    ESYS_TR      policySession = DUMMY_TR_HANDLE_POLICY_SESSION;
    TPM2B_DIGEST cpHashA = DUMMY_2B_DATA(.buffer);
    r = Esys_PolicyCpHash(esys_context, policySession, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                          &cpHashA);
...
test_PolicyNameHash(void **state) {
    ...
    r = Esys_PolicyNameHash(esys_context, policySession, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                            &nameHash);
...
test_PolicyDuplicationSelect(void **state) {
    ...
    r = Esys_PolicyDuplicationSelect(esys_context, policySession, ESYS_TR_NONE, ESYS_TR_NONE,
                                     ESYS_TR_NONE, &objectName, &newParentName, includeObject);
...
test_PolicyAuthorize(void **state) {
    ...
    r = Esys_PolicyAuthorize(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                             ESYS_TR_NONE, &approvedPolicy, &policyRef, &keySign, &checkTicket);
...
test_PolicyAuthValue(void **state) {
    ...
    ESYS_TR policySession_handle = DUMMY_TR_HANDLE_POLICY_SESSION;
    r = Esys_PolicyAuthValue(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                             ESYS_TR_NONE);
...
test_PolicyPassword(void **state) {
    ...
    ESYS_TR policySession_handle = DUMMY_TR_HANDLE_POLICY_SESSION;
    r = Esys_PolicyPassword(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                            ESYS_TR_NONE);
...
test_PolicyGetDigest(void **state) {
    ...
    r = Esys_PolicyGetDigest(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
...
test_PolicyNvWritten(void **state) {
    ...
    r = Esys_PolicyNvWritten(esys_context, policySession_handle, ESYS_TR_NONE, ESYS_TR_NONE,
                             ESYS_TR_NONE, writtenSet);
...
test_PolicyTemplate(void **state) {
    ...
    r = Esys_PolicyTemplate(esys_context, policySession, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                            &templateHash);
...
test_PolicyAuthorizeNV(void **state) {
    ...
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    ESYS_TR policySession_handle = DUMMY_TR_HANDLE_POLICY_SESSION;
    r = Esys_PolicyAuthorizeNV(esys_context, authHandle_handle, nvIndex_handle,
                               policySession_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE);
...
test_CreatePrimary(void **state) {
    ...
    TPM2B_DIGEST          *creationHash;
    TPMT_TK_CREATION      *creationTicket;
    r = Esys_CreatePrimary(esys_context, primaryHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                           ESYS_TR_NONE, &inSensitive, &inPublic, &outsideInfo, &creationPCR,
                           &objectHandle_handle, &outPublic, &creationData, &creationHash,
                           &creationTicket);
...
test_ChangePPS(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    r = Esys_ChangePPS(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                       ESYS_TR_NONE);
...
test_ChangeEPS(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    r = Esys_ChangeEPS(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                       ESYS_TR_NONE);
...
test_Clear(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    r = Esys_Clear(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE);
...
test_ClearControl(void **state) {
    ...
    r = Esys_ClearControl(esys_context, auth_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                          disable);
...
test_DictionaryAttackLockReset(void **state) {
    ...
    ;
    r = Esys_DictionaryAttackLockReset(esys_context, lockHandle_handle, ESYS_TR_PASSWORD,
...
test_DictionaryAttackParameters(void **state) {
    ...
    r = Esys_DictionaryAttackParameters(esys_context, lockHandle_handle, ESYS_TR_PASSWORD,
...
test_SetAlgorithmSet(void **state) {
    ...
    r = Esys_SetAlgorithmSet(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
...
test_FieldUpgradeStart(void **state) {
    ...
    r = Esys_FieldUpgradeStart(esys_context, authorization_handle, keyHandle_handle,
                               ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE, &fuDigest,
                               &manifestSignature);
...
test_FieldUpgradeData(void **state) {
    ...
    TPMT_HA         *nextDigest;
    TPMT_HA         *firstDigest;
    r = Esys_FieldUpgradeData(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &fuData,
...
test_FirmwareRead(void **state) {
    ...
    r = Esys_FirmwareRead(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, sequenceNumber,
                          &fuData);
...
test_EvictControl(void **state) {
    ...
    r = Esys_EvictControl(esys_context, auth_handle, objectHandle_handle, ESYS_TR_PASSWORD,
                          ESYS_TR_NONE, ESYS_TR_NONE, persistentHandle, &newObjectHandle_handle);
...
test_ReadClock(void **state) {
    ...
    r = Esys_ReadClock(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &currentTime);
...
test_ClockSet(void **state) {
    ...
    ESYS_TR auth_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    UINT64  newTime = 0;
    r = Esys_ClockSet(esys_context, auth_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE, ESYS_TR_NONE,
                      newTime);
...
test_ClockRateAdjust(void **state) {
    ...
    r = Esys_ClockRateAdjust(esys_context, auth_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                             ESYS_TR_NONE, rateAdjust);
...
test_GetCapability(void **state) {
    ...
    r = Esys_GetCapability(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, capability,
...
test_TestParms(void **state) {
    ...
    r = Esys_TestParms(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &parameters);
...
test_NV_DefineSpace(void **state) {
    ...
    r = Esys_NV_DefineSpace(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
...
test_NV_UndefineSpace(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    r = Esys_NV_UndefineSpace(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
                              ESYS_TR_NONE, ESYS_TR_NONE);
...
test_NV_UndefineSpaceSpecial(void **state) {
    ...
    r = Esys_NV_UndefineSpaceSpecial(esys_context, nvIndex_handle, platform_handle,
                                     ESYS_TR_PASSWORD, ESYS_TR_PASSWORD, ESYS_TR_NONE);
...
test_NV_ReadPublic(void **state) {
    ...
    TPM2B_NAME      *nvName;
    r = Esys_NV_ReadPublic(esys_context, nvIndex_handle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                           &nvPublic, &nvName);
...
test_NV_Write(void **state) {
    ...
    UINT16              offset = 0;
    r = Esys_NV_Write(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
...
test_NV_Increment(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    r = Esys_NV_Increment(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
                          ESYS_TR_NONE, ESYS_TR_NONE);
...
test_NV_Extend(void **state) {
    ...
    ESYS_TR             nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    TPM2B_MAX_NV_BUFFER data = DUMMY_2B_DATA(.buffer);
    r = Esys_NV_Extend(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
...
test_NV_SetBits(void **state) {
    ...
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    UINT64  bits = 0;
    r = Esys_NV_SetBits(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
                        ESYS_TR_NONE, ESYS_TR_NONE, bits);
...
test_NV_WriteLock(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    r = Esys_NV_WriteLock(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
                          ESYS_TR_NONE, ESYS_TR_NONE);
...
test_NV_GlobalWriteLock(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    r = Esys_NV_GlobalWriteLock(esys_context, authHandle_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                                ESYS_TR_NONE);
...
test_NV_Read(void **state) {
    ...
    r = Esys_NV_Read(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
...
test_NV_ReadLock(void **state) {
    ...
    ESYS_TR authHandle_handle = DUMMY_TR_HANDLE_HIERARCHY_PLATFORM;
    ESYS_TR nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    r = Esys_NV_ReadLock(esys_context, authHandle_handle, nvIndex_handle, ESYS_TR_PASSWORD,
                         ESYS_TR_NONE, ESYS_TR_NONE);
...
test_NV_ChangeAuth(void **state) {
    ...
    ESYS_TR    nvIndex_handle = DUMMY_TR_HANDLE_NV_INDEX;
    TPM2B_AUTH newAuth = DUMMY_2B_DATA(.buffer);
    r = Esys_NV_ChangeAuth(esys_context, nvIndex_handle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                           ESYS_TR_NONE, &newAuth);
...
test_NV_Certify(void **state) {
    ...
    TPM2B_ATTEST   *certifyInfo;
    TPMT_SIGNATURE *signature;
    r = Esys_NV_Certify(esys_context, signHandle_handle, authHandle_handle, nvIndex_handle,
                        ESYS_TR_PASSWORD, ESYS_TR_PASSWORD, ESYS_TR_NONE, &qualifyingData,
...
test_Vendor_TCG_Test(void **state) {
    ...
    r = Esys_Vendor_TCG_Test(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, &inputData,
                             &outputData);
...
test_AC_GetCapability(void **state) {
    ...
    TPMI_YES_NO           moreData;
    r = Esys_AC_GetCapability(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, ac,
                              capability, count, &moreData, &capabilityData);
...
test_Policy_AC_SendSelect(void **state) {
    ...
    r = Esys_Policy_AC_SendSelect(esys_context, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
...
main(int argc, char *argv[]) {
    const struct CMUnitTest tests[]
        = { cmocka_unit_test_setup_teardown(test_Startup, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_IncrementalSelfTest, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_ActivateCredential, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_HashSequenceStart, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_EventSequenceComplete, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_GetSessionAuditDigest, setup, teardown),
            cmocka_unit_test_setup_teardown(test_GetCommandAuditDigest, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_SetCommandCodeAuditStatus, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_PCR_SetAuthPolicy, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_PolicyCounterTimer, setup, teardown),
            cmocka_unit_test_setup_teardown(test_PolicyCommandCode, setup, teardown),
            cmocka_unit_test_setup_teardown(test_PolicyPhysicalPresence, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_PolicyDuplicationSelect, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_PolicyAuthorizeNV, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_HierarchyChangeAuth, setup, teardown),
            cmocka_unit_test_setup_teardown(test_DictionaryAttackLockReset, setup, teardown),
            cmocka_unit_test_setup_teardown(test_DictionaryAttackParameters, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_FieldUpgradeStart, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_NV_UndefineSpaceSpecial, setup, teardown),
            ...
            cmocka_unit_test_setup_teardown(test_NV_GlobalWriteLock, setup, teardown),
