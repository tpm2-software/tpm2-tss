...
#include "tss2_tpm2_types.h"       // for TPM2_CC_AC_Send
...
static TSS2_RC
tcti_fake_ac_send_transmit(TSS2_TCTI_CONTEXT *tcti_ctx, size_t size, const uint8_t *cmd_buf) {
    UNUSED(tcti_ctx);
...
static TSS2_RC
tcti_fake_ac_send_receive(TSS2_TCTI_CONTEXT *tctiContext,
