...
test_esys_policy_physical_presence_opt(ESYS_CONTEXT *esys_context) {
    ...
    r = Esys_PolicyPhysicalPresence(esys_context, sessionTrial, ESYS_TR_NONE, ESYS_TR_NONE,
                                    ESYS_TR_NONE);
    ...
    if (!cmp_policy_digest(esys_context, &sessionTrial, &expectedPolicyPhysicalPresence,
