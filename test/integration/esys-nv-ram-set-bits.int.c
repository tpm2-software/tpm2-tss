...
#include "tss2_common.h"     // for TSS2_RC_SUCCESS, TSS2_RC, UINT64
#include "tss2_esys.h"       // for Esys_Free, ESYS_TR_NONE, Esys_NV_ReadPu...
#include "tss2_tpm2_types.h" // for TPM2B_NAME, TPM2B_NV_PUBLIC, TPM2_ALG_S...
...
test_esys_nv_ram_set_bits(ESYS_CONTEXT *esys_context) {
    ...
    r = Esys_NV_SetBits(esys_context, nvHandle, nvHandle,
#ifdef TEST_SESSION
                        session,
#else
                        ESYS_TR_PASSWORD,
