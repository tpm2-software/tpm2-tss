...
#include "test-fapi.h"            // for ASSERT, ASSERT_SIZE, pcr_bank_sha1_...
#include "tss2_common.h"          // for TSS2_FAPI_RC_MEMORY, TSS2_FAPI_RC_G...
#include "tss2_fapi.h"            // for Fapi_PcrExtend, Fapi_Delete, Fapi_V...
#include "tss2_tpm2_types.h"      // for TPM2_ALG_SHA1, TPM2_ALG_SHA256, TPM...

#define LOGMODULE test
#define LOGDEFAULT LOGLEVEL_INFO
#include "util/log.h"             // for LOGLEVEL_INFO, SAFE_FREE, goto_if_e...
