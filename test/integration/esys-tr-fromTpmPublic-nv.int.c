...
test_esys_tr_fromTpmPublic_nv(ESYS_CONTEXT *ectx) {
    ...
    r = Esys_NV_ReadPublic(ectx, nvHandle, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, NULL, &name1);
    ...
    r = Esys_TR_FromTPMPublic(ectx, TPM2_NV_INDEX_FIRST, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
                              &nvHandle);
    ...
    r = Esys_StartAuthSession(ectx, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE, ESYS_TR_NONE,
    ...
    r = Esys_TR_FromTPMPublic(ectx, TPM2_NV_INDEX_FIRST, session, session2, ESYS_TR_NONE,
                              &nvHandle);
    goto_if_error(r, "TR from TPM public", error_name1);
    ...
    r = Esys_TR_FromTPMPublic(ectx, TPM2_NV_INDEX_FIRST, session, ESYS_TR_NONE, ESYS_TR_NONE,
                              &nvHandle);
    goto_if_error(r, "TR from TPM public", error_name1);
...
error:
    ...
    if (nvHandle != ESYS_TR_NONE) {
        if (Esys_NV_UndefineSpace(ectx, ESYS_TR_RH_OWNER, nvHandle, ESYS_TR_PASSWORD, ESYS_TR_NONE,
                                  ESYS_TR_NONE)
            != TSS2_RC_SUCCESS) {
