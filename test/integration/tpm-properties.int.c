...
test_invoke (TSS2_SYS_CONTEXT *sapi_context)
{
    ...
    if (rc != TSS2_RC_SUCCESS ||
        ...
        print_fail("Get TPM Properties TPM2_PT_MANUFACTURER FAILED! Response Code : 0x%x", rc);
    ...
    if (rc != TSS2_RC_SUCCESS ||
        ...
        print_fail("Get TPM Properties TPM2_PT_REVISION FAILED! Response Code : 0x%x", rc);
