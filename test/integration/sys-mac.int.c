...
test_sys_mac(TSS2_SYS_CONTEXT * sys_context)
{
    ...
    rc = TSS2_RETRY_EXP(Tss2_Sys_MAC(sys_context, primaryHandle, &sessions_cmd,
                        &test_buffer, TPM2_ALG_SHA256, &outMAC, &sessions_rsp));
