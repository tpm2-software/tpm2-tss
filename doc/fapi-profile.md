...
# Check existing SRK
In some cases, an SRK may already exist on the platform and can be reused by FAPI.
This includes dual-boot setups and SRK initialization performed by systemd.
