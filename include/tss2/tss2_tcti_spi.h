 ...
 */
#ifndef TSS2_TCTI_SPI_H
#define TSS2_TCTI_SPI_H
 ...
 * Forward declaration
 *
 * See doc/tcti-spi.md for example platform method implementations.
 */
typedef struct TSS2_TCTI_SPI_PLATFORM TSS2_TCTI_SPI_PLATFORM;

/*
 * Sleeps for the specified amount of milliseconds
 */
typedef void (*TSS2_TCTI_SPI_PLATFORM_SLEEP_MS_FUNC) (void* user_data, int milliseconds);
 ...
 */
typedef void (*TSS2_TCTI_SPI_PLATFORM_START_TIMEOUT_FUNC) (void* user_data, int milliseconds);
 ...
 */
typedef bool (*TSS2_TCTI_SPI_PLATFORM_TIMEOUT_EXPIRED_FUNC) (void* user_data);
 ...
 */
typedef TSS2_RC (*TSS2_TCTI_SPI_PLATFORM_SPI_ACQUIRE_FUNC) (void* user_data);

/*
 * Stops pulling chip select and releases the SPI bus again.
 */
typedef TSS2_RC (*TSS2_TCTI_SPI_PLATFORM_SPI_RELEASE_FUNC) (void* user_data);

/*
 * Transfers cnt bytes from data_out to the SPI slave. Reads the response into data_in.
 */
typedef TSS2_RC (*TSS2_TCTI_SPI_PLATFORM_SPI_TRANSFER_FUNC) (void* user_data, const void *data_out, void *data_in, size_t cnt);
 ...
 */
typedef void (*TSS2_TCTI_SPI_PLATFORM_FINALIZE) (void* user_data);

/*
 * Contains user implemented platform methods for the SPI TCTI.
 *
 * See doc/tcti-spi.md for example implementations.
 */
struct TSS2_TCTI_SPI_PLATFORM {
    void* user_data;
    TSS2_TCTI_SPI_PLATFORM_SLEEP_MS_FUNC sleep_ms;
    TSS2_TCTI_SPI_PLATFORM_START_TIMEOUT_FUNC start_timeout;
    TSS2_TCTI_SPI_PLATFORM_TIMEOUT_EXPIRED_FUNC timeout_expired;
    TSS2_TCTI_SPI_PLATFORM_SPI_ACQUIRE_FUNC spi_acquire;
    TSS2_TCTI_SPI_PLATFORM_SPI_RELEASE_FUNC spi_release;
    TSS2_TCTI_SPI_PLATFORM_SPI_TRANSFER_FUNC spi_transfer;
 ...
 * See doc/tcti-spi.md for example implementations.
 */
TSS2_RC Tss2_Tcti_Spi_Init (
    TSS2_TCTI_CONTEXT *tctiContext,
    size_t *size,
    TSS2_TCTI_SPI_PLATFORM platform_conf);

#ifdef __cplusplus
}
#endif

#endif /* TSS2_TCTI_SPI_H */
